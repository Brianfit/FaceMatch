...
//   outClass: "rotate-out"
// });
$('.game').html('<br /><br /><br /><div class="card"><div class="inside"><div class="back" style="margin: 0 auto; padding-left: 5; padding-top: 10; background-color:#BA55D3;"><a href="javascript:void(0)" class="Change1"><img src="'+Card[1]+'"></a></div></div></div><div class="card"><div class="inside"><div class="back" style="margin: 0 auto; padding-left: 5; padding-top: 10; background-color:#BA55D3;"><a href="javascript:void(0)" class="Change2"><img src="'+Card[2]+'"></a></div></div></div><div class="card"><div class="inside"><div class="back" style="margin: 0 auto; padding-left: 5; padding-top: 10; background-color:#BA55D3;"><a href="javascript:void(0)" class="Change3"><img src="'+Card[3]+'"></a></div></div></div><div class="card"><div class="inside"><div class="back" style="margin: 0 auto; padding-left: 5; padding-top: 10; background-color:#BA55D3;"><a href="javascript:void(0)" class="Change4"><img src="'+Card[4]+'"></a></div></div></div><div class="card"><div class="inside"><div class="back" style="margin: 0 auto; padding-left: 5; padding-top: 10; background-color:#BA55D3;"><a href="javascript:void(0)" class="Change5"><img src="'+Card[5]+'"></a></div></div></div><div class="card"><div class="inside"><div class="back" style="margin: 0 auto; padding-left: 5; padding-top: 10; background-color:#BA55D3;"><a href="javascript:void(0)" class="Change6"><img src="'+Card[6]+'"></a></div></div></div> <br /><div style="width:250px; display:block; clear:both;" class="center">Touch a play tile to change the image to a photo of a pet or family member. You can take a photo or select an image from your library. Add an audio recording of the pet or family member\'s name. All set? Press the green play button.</div><br />');


$('.control').html('<input type="image" onclick="PlayGame()" src="images/play.png" style="height:50; width:50"></a><input type="image" onclick="SetupPix()" src="images/stop.png" style="height:50; width:50;"></input>');
