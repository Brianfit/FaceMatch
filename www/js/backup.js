	...
	var Memory = {
		...
		buildHTML: function(){
			...
			this.$cards.each(function(k, v){
				frag += '<div class="card" data-id="'+ v.id +'"><div class="inside"><div class="front" style="background-color:#BA55D3;"><img src="'+ v.img +'"alt="'+ v.name +'" class="img-responsive" /></div><div class="back" style="background-color:#BA55D3;"><img src="images/heart.png" alt="Heart" /><div id="audio" data-audiofile="'+ v.audio +'"></div></div></div></div>';
